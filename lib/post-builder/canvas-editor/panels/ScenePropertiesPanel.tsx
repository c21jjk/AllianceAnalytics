 ...
 *   • Text overlays, quick badges
 *
 * Transitions are NOT per-scene anymore (2026-06-06) — they're a single global
 * style + speed set from the editor header (ReelStudioClient), applied to every
 * slide. See that file's "global transition" block.
 *
