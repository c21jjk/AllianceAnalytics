...
/**
 * v5 · Three-Photo Grid · Story 9:16 · 1080×1920
 *
 * Hero photo 700×1200 left, two stacked thumbnails 376×598 on the right
 * (with 4px gold gaps). Data block 1080×~720 below ending above the
 * bottom safe zone. Eyebrow positioned below the top safe zone.
 */
export function renderV5ThreePhotoGridStory(args: {
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .photo-hero {
    width: 700px; height: ${photoHeight}px;
  ...
  ${BADGE_CSS}
  /* Story v5: SOLD stamp anchors on the hero photo, mid-frame. */
  .badge-stamp { top: 480px; right: 410px; }
