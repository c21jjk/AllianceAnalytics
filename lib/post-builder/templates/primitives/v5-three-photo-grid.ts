...
/**
 * v5 · Three-Photo Grid · Square 1080×1080
 *
 * Magazine listing-spread composition. Hero photo 700×700 on the left,
 * two stacked thumbnails 376×348 on the right (with 4px gold gaps).
 * Data block 1080×376 across the bottom on a light surface.
 *
 * The "see more of this property" feel of MLS listing pages, translated
 * to a social square.
 */
export function renderV5ThreePhotoGrid(args: {
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  ${BADGE_CSS}
  /* v5: SOLD stamp anchors on the hero photo (the big one). */
  .badge-stamp { top: 80px; right: 410px; }
</style>
<body>
  <div class="frame">
