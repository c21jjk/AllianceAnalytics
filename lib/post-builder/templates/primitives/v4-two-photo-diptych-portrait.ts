...
/**
 * v4 · Two-Photo Diptych · Portrait 4:5 · 1080×1350
 *
 * Side-by-side photos 540×900 in the upper portion (~67% of frame),
 * data block 1080×450 below. Same diptych identity as the square but
 * the taller photos give the architecture room to breathe.
 */
export function renderV4TwoPhotoDiptychPortrait(args: {
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  ${BADGE_CSS}
  .badge-stamp { top: 110px; right: 580px; }
</style>
<body>
  <div class="frame">
    <div class="photo-row">
