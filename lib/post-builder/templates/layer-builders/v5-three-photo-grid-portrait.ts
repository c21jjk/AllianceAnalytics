/**
 * v5 · Three-Photo Grid · Portrait 4:5 · 1080×1350 (LayerTree builder)
 *
 * Hero 700×900 left, two stacked thumbnails on the right (5px gold gap).
 * Light data block 1080×450 below with a 5px accent border on top.
 */
...
export function buildV5ThreePhotoGridPortrait(args: {
  ...
  return {
    ...
    layers,
    source: {
      template_id: `${args.theme.post_type}_portrait_v5`,
