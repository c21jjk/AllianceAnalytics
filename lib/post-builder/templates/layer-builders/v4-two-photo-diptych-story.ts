/**
 * v4 · Two-Photo Diptych · Story 9:16 · 1080×1920 (LayerTree builder)
 *
 * Photos 537×1200 with 5px gold seam; data block ends above the bottom
 * safe zone. Eyebrow drops below the top safe zone.
 */
...
export function buildV4TwoPhotoDiptychStory(args: {
  ...
  return {
    ...
    layers,
    source: {
      template_id: `${args.theme.post_type}_story_v4`,
