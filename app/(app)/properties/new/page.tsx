...
export const metadata = { title: "Add listing — Alliance Social" };

/**
 * Standalone full-page version of "Add listing". Hit directly via URL or
...
export default async function NewPropertyPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Add a listing"
        description="Manual entry — for listings that aren't in the MLS feeds yet, or one-off pocket listings. CMC, SJSR, and Bright listings auto-populate via RETS sync."
      />
